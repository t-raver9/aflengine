...
#adv_stats["fullname"] = adv_stats.apply(f.nameClean,axis=1)
#adv_stats["namekey"] = adv_stats.apply(f.getNameKeyFW,axis=1)
#adv_stats["fullkey"] = adv_stats.apply(f.getFullKey,axis=1)
...
idx = [0,1,34,35,57,58,42,43]
player_full.drop(player_full.columns[idx],axis=1,inplace=True)
...
player_full.drop(['kicks_y','matchid_y','namekey_y'],axis=1,inplace=True)
player_full.rename(columns={"namekey_x":"namekey"},inplace=True)

x = player_full.columns
